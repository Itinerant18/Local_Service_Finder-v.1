...
const ProviderProfile = () => {
  ...
  const { data: providerData, isLoading, isError, error } = useProvider(providerId);

  // Mock fallback until backend data exists
        ...
        <main className="pt-16 pb-20 lg:pb-8">
          <div className="max-w-4xl mx-auto px-4 py-12">
            <div className="rounded-lg border border-error/20 bg-error/5 p-6">
              <h1 className="text-lg font-semibold text-error mb-2">Unable to load provider</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="grid lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-3 space-y-6">
              <ProfileHeader provider={provider} loading={isLoading} />
